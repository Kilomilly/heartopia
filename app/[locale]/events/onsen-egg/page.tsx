...
export async function generateMetadata({
    ...
    return {
        ...
        alternates: {
            canonical: `https://theheartopia.com/${locale}/events/onsen-egg`,
            languages: {
                "en": "https://theheartopia.com/en/events/onsen-egg",
                "th": "https://theheartopia.com/th/events/onsen-egg",
                "pt": "https://theheartopia.com/pt/events/onsen-egg",
                "es": "https://theheartopia.com/es/events/onsen-egg",
                "x-default": "https://theheartopia.com/en/events/onsen-egg",
            },
        },
        openGraph: {
            title: o.metaTitle,
            description: o.metaDesc,
            url: `https://theheartopia.com/${locale}/events/onsen-egg`,
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "position": 3,
                "name": o.heroTitle,
                "item": `https://theheartopia.com/${locale}/events/onsen-egg`
            }
        ]
    }
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <section className="bg-gradient-to-br from-heartopia-cream to-white rounded-3xl p-8 border border-orange-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Link
                                href={`/${locale}/events/meteor-shower`}
