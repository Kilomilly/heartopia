...
import { ChevronRight, Home, Gavel, Scale, FileCheck, CheckCircle2 } from "lucide-react"
...
export async function generateMetadata({
    ...
    return {
        ...
        alternates: {
            canonical: `https://theheartopia.com/${locale}/terms-of-service`,
            languages: {
                "en": "https://theheartopia.com/en/terms-of-service",
                "th": "https://theheartopia.com/th/terms-of-service",
                "pt": "https://theheartopia.com/pt/terms-of-service",
                "es": "https://theheartopia.com/es/terms-of-service",
                "x-default": "https://theheartopia.com/en/terms-of-service",
            },
        },
    }
}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
                        <div className="flex items-center gap-4 bg-white/40 p-6 rounded-3xl border border-white">
                            <Gavel className="w-10 h-10 text-heartopia-pink" />
                            <div>
                                <h4 className="font-bold text-foreground text-sm">Rules of Play</h4>
                                <p className="text-xs text-muted-foreground">Terms for using our site</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 bg-white/40 p-6 rounded-3xl border border-white">
                            <Scale className="w-10 h-10 text-heartopia-sky" />
                            <div>
                                <h4 className="font-bold text-foreground text-sm">Fair Use</h4>
                                <p className="text-xs text-muted-foreground">Legal clarity for everyone</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 bg-white/40 p-6 rounded-3xl border border-white">
                            <CheckCircle2 className="w-10 h-10 text-heartopia-orange" />
                            <div>
                                <h4 className="font-bold text-foreground text-sm">Agreement</h4>
                                <p className="text-xs text-muted-foreground">Consent upon using site</p>
                            </div>
                        </div>
                    </div>
                </div>
